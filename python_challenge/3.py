...
for index, char in enumerate(mess):
    if (char.islower() and mess[index+1:index+4].isupper() and mess[index-3:index].isupper() and
        mess[index-4].islower() and mess[index+4].islower()):
        print(mess[index-4:index+5])
        url += char
